...
const getAll = async (dados: ISendPagination): Promise<any | Error> => {
  ...
  return await api
    .post<IProductSearch>(environment.url_product_search, dados, token)
    .then((data) => {
...
const getByIDd = async (id: string): Promise<any | Error> => {
  ...
  return await api
    .get(environment.url_product + `/${id}`, token)
    .then((data) => {
      if (data instanceof AxiosError) {
...
const UpdateById = async (
  ...
  return await api
    .put<any>(environment.url_product + `/${id}`, dados, token)
    .then((data) => {
      if (data instanceof AxiosError) {
        return data.response?.data;
      }
...
const DeleteById = async (id: string): Promise<void | Error> => {
  ...
  return await api
    .delete(environment.url_product + `/${id}`, token)
    .then((data) => {
      if (data instanceof AxiosError) {
        return data.response?.data;
      }
...
const Create = async (dados: IDataProductRegiser): Promise<any | Error> => {
  ...
  return await api
    .post<any>(environment.url_product, dados, token)
    .then((data) => {
      if (data instanceof AxiosError) {
        return data.response?.data;
      }
